...
<div class="content">
    <div class="banner">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                    <img src="../images/logo2.png" class="img-responsive lambo">
                </div>
                <div class="col-md-4">
                    <h1>Lamborhini</h1>
                </div>
    ...
    <div class="container models">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/l6.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/l2.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/l3.jpg" class="img" alt="Lights" style="width:100%;">
                        <div class="caption">
                            <p>Lamboghini Veneno</p>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/l4.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>Lamboghini Hurrican</p>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="#">
                        <img src="../images/l5.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>Lamboghini Gallardo</p>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/l1.jpg" class="img" alt="Lights" style="width:100%;">
                        <div class="caption">
                            <p> Lamboghini Murcielago</p>
                        </div>
                    </a>
                </div>
            </div>
