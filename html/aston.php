...
<div class="content">
    <div class="banner">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1">
                    <img src="../images/logo6.png" class="img-responsive">
                </div>
                <div class="col-md-4">
                    <h1>Aston martin</h1>
                </div>
    ...
    <div class="container models">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f1.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>812 superfast</p>
                        </div>
                    </a>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f2.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>F430</p>
                        </div>
                    </a>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f3.jpg" class="img" alt="Lights" style="width:100%;">
                        <div class="caption">
                            <p>LaFerrari</p>
                        </div>
                    </a>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f458.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>f458</p>
                        </div>
                    </a>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f460.jpg" class="img" alt="Lights" style="width:100%">
                        <div class="caption">
                            <p>f460</p>
                        </div>
                    </a>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="">
                        <img src="../images/f488.jpg" class="img" alt="Lights" style="width:100%;">
                        <div class="caption">
                            <p>f488</p>
                        </div>
                    </a>
